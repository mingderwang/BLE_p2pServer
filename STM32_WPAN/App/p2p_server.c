	...
	case HCI_VENDOR_SPECIFIC_DEBUG_EVT_CODE:
		...
		case ACI_GATT_ATTRIBUTE_MODIFIED_VSEVT_CODE:
			...
			if (p_attribute_modified->Attr_Handle
				...
				notification.DataTransfered.p_Payload =
		...
		case ACI_GATT_TX_POOL_AVAILABLE_VSEVT_CODE: {
			...
			p_tx_pool_available_event =
					(aci_gatt_tx_pool_available_event_rp0*) p_blecore_evt->data;
		...
		case ACI_ATT_EXCHANGE_MTU_RESP_VSEVT_CODE: {
			...
			p_exchange_mtu =
					(aci_att_exchange_mtu_resp_event_rp0*) p_blecore_evt->data;
...
void P2P_SERVER_Init(void) {
	...
	PRIMARY_SERVICE, 6, &(P2P_SERVER_Context.P2p_serverSvcHdle));
	...
	UUID_TYPE_128, (Char_UUID_t*) &uuid, SizeLed_C,
	CHAR_PROP_READ | CHAR_PROP_WRITE_WITHOUT_RESP,
	ATTR_PERMISSION_NONE,
	GATT_NOTIFY_ATTRIBUTE_WRITE, 0x10,
	CHAR_VALUE_LEN_VARIABLE, &(P2P_SERVER_Context.Led_CCharHdle));
	if (ret != BLE_STATUS_SUCCESS) {
	...
	ret = aci_gatt_add_char(P2P_SERVER_Context.P2p_serverSvcHdle,
	UUID_TYPE_128, (Char_UUID_t*) &uuid, SizeSwitch_C,
	CHAR_PROP_NOTIFY,
	ATTR_PERMISSION_NONE,
	GATT_NOTIFY_ATTRIBUTE_WRITE, 0x10,
	CHAR_VALUE_LEN_VARIABLE, &(P2P_SERVER_Context.Switch_CCharHdle));
	if (ret != BLE_STATUS_SUCCESS) {
...
tBleStatus P2P_SERVER_UpdateValue(P2P_SERVER_CharOpcode_t CharOpcode,
	...
	case P2P_SERVER_LED_C:
		ret = aci_gatt_update_char_value(P2P_SERVER_Context.P2p_serverSvcHdle,
				P2P_SERVER_Context.Led_CCharHdle, 0, /* charValOffset */
	...
	case P2P_SERVER_SWITCH_C:
		ret = aci_gatt_update_char_value(P2P_SERVER_Context.P2p_serverSvcHdle,
				P2P_SERVER_Context.Switch_CCharHdle, 0, /* charValOffset */
				pData->Length, /* charValueLen */
				(uint8_t*) pData->p_Payload);
		if (ret != BLE_STATUS_SUCCESS) {
